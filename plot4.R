...
#set the plot dimensions for 4 plots 

par(mfrow = c(2,2))

#first plot of Active power vs time
plot(power$dateTime, power$Global_active_power, type = "l", col = "black", ylab = "Global Active Power", xlab = "")

#second plot of Voltage vs time
plot(power$dateTime, power$Voltage, type = "l", col = "black", ylab = "Voltage", xlab = "datetime")

#3rd plot of Energy Sub Metering vs time
with(power, {
...
#4th plot - global reactive power vs time.
plot(power$dateTime, power$Global_reactive_power, type = "l", col = "black", ylab = "Global Reactive Power", xlab = "datetime")
